...
During the timespan of DNA repair, NER factors accumulate and then gradually decrease from their plateau levels at different rates (cf.\ Figure \ref{fig:accuImage}C). For example, the half-life $t_\text{1/2}$ for XPC- and XPG-EGFP is $\sim$1 h but $\sim$2.5 h for XPA-EGFP \cite{Luijsterburg2010}. In contrast, PCNA and RPA stay present in the damage spot even after lesion removal. These results show that NER factors engage for hours in the repair process with temporal changes in the molecular composition.\\
...
\subsection{Repair rate follows first order rate kinetics}
...
% * <l.adlung@dkfz.de> 2014-12-07T00:14:27.396Z:
%
%  More important: Here it should be mentioned once more why EdU corporation is inversely correlated with 6-4PP removal.
%
% * <l.adlung@dkfz.de> 2014-12-07T00:13:30.350Z:
%
%  Have second order kinetics been tested, too and checked not to perform significantly better? 
%
% ^ <l.adlung@dkfz.de> 2014-12-07T10:07:30.533Z.
\begin{figure}[b!]
\begin{center}
...
% * <l.adlung@dkfz.de> 2014-12-07T00:20:46.664Z:
%
%  This stochastic distribution comes a bit out of the blue. Mention that, due to sparse interactions, even fast binding events take overall long to be established
%
