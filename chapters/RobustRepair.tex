...
\begin{figure}[htbp]
	...
	\end{center}
\end{figure}
This result is illustrated more explicitly by comparing the strikingly matching temporal evolution of the measured and predicted distributions of repair synthesis (cf.\ Figure \ref{fig:ModelData_tempVar}).
